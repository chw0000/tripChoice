	...
	<div class="row text-center">
		<div class="col-sm-3">
			<div class="thumbnail2">
				...
				<a href="<%=request.getContextPath()%>/tbrqList.do" class="btn btn-warning">자주 찾는 질문 바로가기</a>
			</div>
		</div>
		<div class="col-sm-3">
			<div class="thumbnail2">
				...
				<p>솔직한 리뷰를 써주세요!</p>
				<a href="<%=request.getContextPath()%>/trvList.do"  class="btn btn-info">리뷰 바로가기</a>
			</div>
		</div>
		<div class="col-sm-3">
			<div class="thumbnail2">
				...
				<p>언제든지 문의하세요~</p>
				<a href="<%=request.getContextPath()%>/trqList.do"  class="btn btn-success">문의사항 바로가기</a>
			</div>
		</div>
		<div class="col-sm-3">
			<div class="thumbnail2">
				...
				<p>하고 싶은 말을 보내주세요</p>
				<a href="<%=request.getContextPath()%>/mailForm.do" class="btn btn-danger">메일보내기</a>
			</div>
		</div>
	</div>
